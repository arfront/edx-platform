...
from .views import CourseDetailView, CourseListView, CourseshareofwechatView

urlpatterns = [
    url(r'^v1/coursessharewechat/$', CourseshareofwechatView.as_view(), name='couseshare-wechat'),
